...
const ja: Record<TranslationKey, string> = {
  ...
  sheet: "シート",
  shortcutBold: "太字",
  shortcutClose: "ショートカットを閉じる",
  shortcutFindReplace: "検索と置換",
  shortcutItalic: "斜体",
  shortcutRedo: "やり直し",
  shortcutSelectAll: "すべて選択",
  shortcutStrikethrough: "取り消し線",
  shortcutsHelpHint: "? キーでこの一覧を開きます",
  shortcutsTitle: "キーボードショートカット",
  shortcutUnderline: "下線",
  shortcutUndo: "元に戻す",
  size: "サイズ",
  slide: "スライド",
